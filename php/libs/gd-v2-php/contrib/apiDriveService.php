...
class About extends apiModel {
  ...
  public $selfLink;
  protected $__installedAppsType = 'AboutInstalledApps';
  protected $__installedAppsDataType = 'array';
  ...
  public function setInstalledApps(/* array(AboutInstalledApps) */ $installedApps) {
    $this->assertIsArray($installedApps, 'AboutInstalledApps', __METHOD__);
...
class AboutInstalledApps extends apiModel {
